...
Archived 22 September 2026. This document was live at `/privacy` until that date, when the
...
- **Usage & device data** — pages visited, actions taken, approximate location (from IP), browser and device type. We use product-analytics and session-replay tools (see §6) to understand how the product is used and to fix problems.
- **Cookies and similar technologies** — used to keep you signed in and to measure usage (see §7).
...
| Process payments and prevent fraud | Performance of a contract / legal obligation — Art. 6(1)(b), (c) |
| Analytics, session replay and product improvement | Consent or legitimate interest — Art. 6(1)(a)/(f) |
| Security, abuse prevention and debugging | Legitimate interest — Art. 6(1)(f) |
| Sending service and (with consent) marketing emails | Legitimate interest / consent — Art. 6(1)(f)/(a) |
| Meeting tax and accounting obligations | Legal obligation — Art. 6(1)(c) |
| Business contact research (radar/leads): reading third-party public content on social platforms to propose conversations to join and contact drafts | Legitimate interest — Art. 6(1)(f) |
...
You are always dealing with an AI system, and we say so in the product: the assistant identifies itself as an AI, and every draft it produces is shown as AI-generated inside the app before you approve it. Under Regulation (EU) 2024/1689 (the "AI Act") we are the provider of that system; the underlying models come from the providers listed in §6.

We do not use your personal data to take decisions that produce legal effects concerning you, or similarly significantly affect you, within the meaning of Article 22 GDPR. The Service scores and ranks content, keywords and posts — not people — and a human, you, decides what is published.

We keep a technical log of the AI actions run on your brand (which action, when, from which account, which model, what it cost in credits). It exists so that you can reconstruct what the system did, and so that we can debug failures, meter usage and investigate abuse. It follows the retention rules in §9.

Requests that our automatic screen matches against the practices prohibited by Article 5 of the AI Act are flagged in the conversation and recorded in that log. We may review those records to protect the service and to comply with the law. The screen is a keyword heuristic: a flag is a prompt to look, not a finding against you.
...
| kie.ai | AI image / video generation |
...
| Meta (Instagram, Facebook) & TikTok | Publishing posts to your connected accounts |
