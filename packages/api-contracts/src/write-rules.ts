...
export const TABLE_CHECKS: Record<string, string> = {
  ...
  "brand_canvas_items_ref_kind_check": "ref_kind in ('post', 'media', 'document', 'memory', 'graphic', 'note', 'gen')",
  "brand_canvas_items_ref_shape": "(ref_kind = 'note' and ref_id is null) or (ref_kind = 'gen') or (ref_kind not in ('note', 'gen') and ref_id is not null)",
