...
**`packages/*` cannot import the app.** The five agent packages (`@feega/agent-{kit,contracts,core,adapters,client}`)
...
The `feega` CLI, its MCP server and the publishable agent skills live in [`cli/`](cli/) of this
