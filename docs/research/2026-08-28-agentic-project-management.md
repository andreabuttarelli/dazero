# APM (Agentic Project Management) — cosa può servire ad dazero
...
## Differenza strutturale con dazero
...
l'umano. dazero è l'opposto per costruzione: autopilot, la squadra agisce e l'utente decide.
