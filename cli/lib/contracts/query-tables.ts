...
export const QUERY_TABLES =
  ...
  'brand_field_posts brand_geo_artifacts brand_geo_audits brand_internal_links brand_invites brand_job_optouts ' +
  'brand_kit brand_knowledge_edges brand_knowledge_sources brand_market_references brand_media brand_members ' +
  'brand_memory brand_news_items brand_news_sources brand_pages brand_site_pages brand_sites brand_social_handles ' +
  'brand_strategy brand_triggers brand_usage brand_visual_insights brand_webhooks brands chat_artifacts ' +
  'chat_jobs chat_messages chat_model_catalog chat_threads competitors content_plans content_quality_samples ' +
