  ...
  try {
    ...
    if (!res.ok) {
      if (res.status === 404) {
        ...
        console.log(`  Scarica manualmente da: https://github.com/andreabuttarelli/dazero/releases`);
      } else {
    ...
    console.log(`  curl -sSL https://raw.githubusercontent.com/andreabuttarelli/dazero/main/cli/scripts/install.sh | bash\n`);
    process.exit(1);
  }
}
