...
// self-hosted caricava il pixel Meta di dazero e identificava i propri utenti nel nostro
...
export function startAnonymousAnalytics() {
  ...
  whenIdleOrInteract(() => {
    ...
    posthog()?.init(key, {
      api_host: 'https://eu.i.posthog.com', // dazero project lives on PostHog EU cloud
