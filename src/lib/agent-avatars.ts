...
/**
 * L'agente feega: un avatar fisso, uguale ovunque nell'app. È la sua identità, come il marchio
...
export const BUILTIN_AGENT_AVATARS: Record<string, { face: AgentAvatarFace; color: string }> = {
  // `auto` è feega: resta in tinta col tema, è l'unico neutro. Le chiavi devono essere gli id
