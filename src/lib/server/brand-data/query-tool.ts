...
export const NO_SESSION_ERROR = {
  ...
  fix: 'Use this surface\'s own read tools — there is one per subject, and each scopes to this brand by construction. Or come back as yourself: `query` reads wherever the caller carries their own session — the app, `feega login`, and MCP.'
} as const;
