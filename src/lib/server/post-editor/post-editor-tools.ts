...
import { designGraphicVideoBlock, resolveMakeVideoSource } from './post-editor-video';
...
import { createGraphicSourceEditTools, compactGraphicPersist } from './graphic-source-edit';
...
async function applyYoutubeThumbnail(
  ...
  const { gateToolCall } = await import('./tool-policy');
