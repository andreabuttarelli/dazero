// Cookie consent for the PUBLIC brand blog — independent from dazero's app consent (different
// visitor, different domain). It gates dazero's Meta Pixel and the brand's own analytics, which
...
const KEY = 'dazero_blog_consent_v1';
