...
<div class="docs-breadcrumb"><a href={'/docs'}>{$_('docs.credits.s2')}</a><span>/</span>{$_('docs.credits.s3')}</div>
...
<ul>
  <li><a href={'/docs/getting-started'}>{$_('docs.credits.s36')}</a> {$_('docs.credits.s37')}</li>
</ul>
