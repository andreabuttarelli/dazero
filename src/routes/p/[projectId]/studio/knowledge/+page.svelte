<script lang="ts">
  ...
  async function openDoc(id: string) {
    ...
    detailLoading = true;
    try {
      const res = await fetch(`/app/${$page.params.brand}/studio/knowledge/${id}`);
...
<div class="content knowledge-page">
  ...
  <section class="block panel">
    <div class="sec-head">
      ...
      <a class="btn primary add-cta" href={`/app/${brandSlug}/studio/knowledge/new`}>
    ...
    {#if documents.length === 0}
      <div class="empty-box">
        ...
        <a class="btn ghost" href={`/app/${brandSlug}/studio/knowledge/new`}>{$_('app.knowledge.addDocument')}</a>
      </div>
    {:else}
      <div class="toolbar">
        <input
  ...
  <section class="block panel">
    <div class="sec-head">
      ...
      <a class="btn primary add-cta" href={`/app/${brandSlug}/studio/knowledge/memory/new`}>
        <Plus size={16} strokeWidth={2} />
    ...
    {#if filteredMemories.length === 0}
      <div class="empty-box">
        ...
        <a class="btn ghost" href={`/app/${brandSlug}/studio/knowledge/memory/new`}>{$_('app.knowledge.addMemory')}</a>
      </div>
    {:else}
      <Tooltip.Provider>
      <div class="mem-grid">
