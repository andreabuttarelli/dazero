...
// Rotta pubblica, senza sessione: il token È l'autorizzazione, come /blog/[site]. Legge
// con la chiave di servizio perché la sola riga raggiungibile è quella la cui
